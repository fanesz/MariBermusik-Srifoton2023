    ...
    <div className="flex gap-2">
      <div>
        {materi.data.tingkatan && (
          <div className={`text-sm ${{ pemula: 'bg-green-300', menengah: 'bg-orange-300', sulit: 'bg-red-300', }[materi.data.tingkatan.toLocaleLowerCase()]} w-fit px-2 rounded-md text-white`}>
            {materi.data.tingkatan}
          </div>
        )}
      </div>
