...
const Hm = () => {
  return (
    <div className="border border-green-600 overflow-x-hidden">
      ...
      {/* top */}
      <div className="absolute top-0 h-72 w-full flex items-center justify-around border border-red-700">
