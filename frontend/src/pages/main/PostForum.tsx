        ...
        <div className="p-10">
            ...
            <form action="" className="">
                ...
                <div className="px-16 mb-6">
                    ...
                    <div className="my-6">
                        <textarea className="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 focus:bg-white focus:border-green-600 resize-none" id="deskripsi" rows="3"></textarea>
                    </div>
                </div>
